...
with st.sidebar.form(key='weights_form'):
    variable1 = st.slider('Strategic Alignment', 0.0, 1.0, 0.2,step=0.1)
    variable2 = st.slider('Client Focus and Business Need', 0.0, 1.0, 0.3,step=0.1)
    variable3 = st.slider('Risk', 0.0, 1.0, 0.2,step=0.1)
    variable4 = st.slider('Scalability', 0.0, 1.0, 0.15,step=0.1)
    variable5 = st.slider('Interoperability', 0.0, 1.0, 0.15,step=0.1)
    variable6 = st.slider('Project Readiness', 0.0, 1.0, 0.10,step=0.1)

# Calculate the total weight
total_weight = variable1 + variable2 + variable3 + variable4 + variable5
